...
for img_file in file_list:
    ...
    for i in range(len(imgs_to_process)):
        ...
        for prop in regions:
            B = prop.bbox
            if B[2] - B[0] < 475 and B[3] - B[1] < 475 and B[0] > 40 and B[
                2] < 472:
...
for fname in file_list:
    ...
    for i in range(len(imgs_to_process)):
        ...
        img = imgs_to_process[i]
        new_size = [512, 512]  # we're scaling back up to the original size
        # of the image
        ...
        img[
            img == old_min] = new_mean - 1.2 * new_std  # resetting backgound color
        img = img - new_mean
        img = img / new_std
